...
public final class TypeNames {
  ...
  public static final String APT_ANNOTATION_ABANDONED = "cn.labzen.web.api.annotation.Abandoned";
  public static final String APT_ANNOTATION_CACHING = "cn.labzen.web.api.annotation.Caching";
  public static final String APT_ANNOTATION_CALL = "cn.labzen.web.api.annotation.Call";
  public static final String APT_ANNOTATION_CRYPTO = "cn.labzen.web.api.annotation.Crypto";
  public static final String APT_ANNOTATION_LABZEN_CONTROLLER = "cn.labzen.web.api.annotation.LabzenController";
