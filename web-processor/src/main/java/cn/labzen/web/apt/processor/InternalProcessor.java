...
public sealed interface InternalProcessor permits CreativeProcessor,
                                                  EvaluateFieldsProcessor,
                                                  EvaluateMethodsProcessor,
                                                  MetadataGenerateProcessor,
                                                  PrepareProcessor,
                                                  ReadAnnotationsProcessor,
                                                  ReadSourceProcessor {
